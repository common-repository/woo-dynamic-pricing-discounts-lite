...
class Rtwwdpdl_Woo_Dynamic_Pricing_Discounts_Lite_Admin
{
	 ...
	 * @since 1.0.0
	 */
	public function rtwwdpdl_plugin_row_meta_action_links($plugin_meta, $plugin_file, $plugin_data)
	{
		if (isset($plugin_data['TextDomain']) && $plugin_data['TextDomain'] !== 'rtwwdpdl-woo-dynamic-pricing-discounts-lite')
		{
			return $plugin_meta;
		}
		$url = '';
		$url = esc_url('https://wordpress.org/plugins/woo-dynamic-pricing-discounts-lite/#reviews');
