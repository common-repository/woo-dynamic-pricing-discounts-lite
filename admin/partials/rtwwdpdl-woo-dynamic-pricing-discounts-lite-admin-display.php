...
<!-- <div class="rtw_sb_popup">
	<div class="rtw_sb_card">
		<div class="rtw_sb_card_label">
			<label> <?php echo esc_html_e('Limited Period Offer','rtwwdpdl-woo-dynamic-pricing-discounts-lite')?></label>
		</div>
		<div class="rtw_sb_card_body">
			<div class="rtw_sb_close_popup">
				<div class="rtw_sb_close_icon"></div>
			</div>
			<h2><?php echo esc_html_e('Get PRO @ 20% Off','rtwwdpdl-woo-dynamic-pricing-discounts-lite')?></h2>
			...
			<p class="rtw_sb_price"><?php echo esc_html_e('Just in ','rtwwdpdl-woo-dynamic-pricing-discounts-lite')?><span><strike>$49</strike></span><span>$39</span></p>
