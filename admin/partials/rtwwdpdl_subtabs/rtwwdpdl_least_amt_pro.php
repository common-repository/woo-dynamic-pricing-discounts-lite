<span class="rtwwdpdl_pro_text"><?php esc_html_e('This feature is available in Pro version', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?>
	<a target="_blank" href="<?php echo esc_url('https://codecanyon.net/item/woocommerce-dynamic-pricing-discounts-with-ai/24165502'); ?>"><?php esc_html_e('Get it now', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></a>
</span>
	...
	<table class="rtwtable table table-striped table-bordered dt-responsive nowrap" data-value="categor" cellspacing="0">
		<thead>
			<tr>
				...
				<th><?php esc_attr_e('Discount On', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
				<th><?php esc_attr_e('Min Product Count', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
				<th><?php esc_attr_e('Discount Value(%)', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
				<th><?php esc_attr_e('Notice', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
				...
				<th><?php esc_attr_e('Excluded Products having Tags', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
