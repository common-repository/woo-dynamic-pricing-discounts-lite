								...
								<div class="options_group rtwwdpdl_active" id="rtwcat_rule_tab">
									...
									<table class="rtwwdpdl_table_edit">
										...
										<tr>
											...
											<td>
												<?php
												// update: Listing of categorie and subcategorie with the below code 
												$rtwwdpdl_categories = get_terms('product_cat', array(
													'orderby' => 'name',
													'hide_empty' => 0,
													'parent' => 0,
												));
												...
												if (is_array($rtwwdpdl_categories) && !empty($rtwwdpdl_categories))
												{
													...
													{
														$cats['maincate_' . $cat->term_id] = $cat->name;
														...
														if (is_array($subcategories) && !empty($subcategories))
														{
															...
															{
																$cats['subcate_' . $subcat->term_id] = '&nbsp;&nbsp;- ' . $subcat->name;
															}
														}
													}
												}
												// update: Listing of categorie and subcategorie with the above code 
										...
										<tr>
											...
											<td>
												<select name="rtwwdpdl_check_for_cat" id="rtwwdpdl_check_for_cat">
													...
													<option value="rtwwdpdl_price" <?php selected($rtwwdpdl_prev_prod['rtwwdpdl_check_for_cat'], 'rtwwdpdl_price'); ?>><?php esc_html_e('Price', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></option>
													<option value="rtwwdpdl_weight" <?php selected($rtwwdpdl_prev_prod['rtwwdpdl_check_for_cat'], 'rtwwdpdl_weight'); ?>><?php esc_html_e('Weight', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></option>
												</select>
				...
				{ ?>
					<tbody>
						...
						foreach ($rtwwdpdl_products_option as $key => $value)
						{
							...
							{	// shubham
								echo esc_html__($products[explode('_', $value['category_id'])[1]], 'rtwwdpdl-woo-dynamic-pricing-discounts-lite');
							}
							echo '</td>';
