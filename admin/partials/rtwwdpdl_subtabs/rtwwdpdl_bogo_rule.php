...
if (isset($_POST['rtwwdpdl_save_rule']))
{
	if (isset($_POST['rtwwdpd_bogo_field']) && wp_verify_nonce($_POST['rtwwdpd_bogo_field'], 'rtwwdpd_bogo'))
	{
		...
		update_option('rtwwdpdl_bogo_rule', $rtwwdpdl_products_option);
?>
		<div class="notice notice-success is-dismissible rtwwdpdl_auto_remove_notice">
										...
										<tbody id="product_list_body">
											...
											?>
													<tr>
														...
														<td id="td_quant">
															<input type="number" min="0" name="combi_quant[]" required value="<?php echo isset($rtwwdpdl_prev_prod['combi_quant'][$key]) ? $rtwwdpdl_prev_prod['combi_quant'][$key] : ''; ?>" />
														</td>
														<td id="td_remove">
												...
												<tr>
													...
													<td id="td_quant">
														<input type="number" min="0" name="combi_quant[]" required value="" />
													</td>
													<td id="td_remove">
									...
									<table id="rtwbogo_table_pro">
										<thead>
											<tr>
												...
												<th class="rtwtable_header"><?php esc_attr_e('Quantity', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
												<th class="rtwtable_header"><?php esc_attr_e('Discount value (%)', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
										...
										<tbody id="rtw_bogo_row">
											...
											?>
													<tr>
														...
														<td id="td_quant">
															<input type="number" min="0" name="bogo_quant_free[]" required value="<?php echo isset($rtwwdpdl_prev_prod['bogo_quant_free'][$key]) ? esc_attr($rtwwdpdl_prev_prod['bogo_quant_free'][$key]) : ''; ?>" />
														</td>
														<?php
														$rtwwdpdl_bogo_prcnt_off = isset($rtwwdpdl_prev_prod['rtwwdpdl_bogo_prcnt_off'][$key]) ? $rtwwdpdl_prev_prod['rtwwdpdl_bogo_prcnt_off'] : 100;
														?>
														<td><input type="number" value="<?php echo $rtwwdpdl_bogo_prcnt_off ?>" min="0" step="0.01" name="rtwwdpdl_bogo_prcnt_off"><span style="display:block"><i>Default Discount (100 %).</i></span></td>
														<td id="td_remove">
															<a class="button insert remove" name="deletebtn" id="deletebtn"><?php esc_html_e('Remove', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></a>
														</td>
													</tr><?php }
												...
												<tr>
													...
													<td id="td_quant">
														<input type="number" min="0" name="bogo_quant_free[]" required value="" />
													</td>
													<td id="td_remove">
														<?php esc_html_e('Min One product.', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?>
													</td>
								...
								<table id="rtwbogo_table_pro">
									...
									<tbody id="rtw_bogo_row">
										<tr>
											...
											<td>
												<input type="number" value="" min="0" step="0.01" name="rtwwdpdl_bogo_prcnt_off">
												<span style="display:block"><i>Default Discount (100 %).</i></span>
											</td>
											<td id="td_remove">
												<?php esc_html_e('Min One product.', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?>
											</td>
...
<table class="rtwtable table table-striped table-bordered dt-responsive nowrap" data-value="bogo_tbl" cellspacing="0">
	<thead>
		<tr>
			...
			<th><?php esc_html_e('Discount value (%)', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
	...
	{ ?>
		<tbody>
			...
			foreach ($rtwwdpdl_products_option as $key => $value)
			{
				...
				echo '<td>' . (!empty($value['rtwwdpdl_bogo_prcnt_off']) ? esc_html__($value['rtwwdpdl_bogo_prcnt_off'], 'rtwwdpdl-woo-dynamic-pricing-discounts-lite') : '100') . '</td>';
				echo '</td>';
				echo '<td>';
