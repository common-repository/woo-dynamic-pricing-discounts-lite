	...
	<table class="rtwtable table table-striped table-bordered dt-responsive nowrap" data-value="categor_com" cellspacing="0">
		<thead>
			<tr>
				...
				<th><?php esc_html_e('Min Purchase Product', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
				<th><?php esc_html_e('Calculate Total/Subtotal', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
				<th><?php esc_html_e('Min Order Total', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
				...
				<th><?php esc_html_e('Excluded Categories', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?></th>
