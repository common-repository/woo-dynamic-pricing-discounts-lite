								...
								<tr>
									...
									<td>
										<select name="rtw_dscnt_on" value="<?php isset($rtwwdpdl_gnrl_set['rtw_dscnt_on']) ? $rtwwdpdl_gnrl_set['rtw_dscnt_on'] : ''; ?>">
											<option value="rtw_sale_price" <?php selected(isset($rtwwdpdl_gnrl_set['rtw_dscnt_on']) ? $rtwwdpdl_gnrl_set['rtw_dscnt_on'] : '', 'rtw_sale_price'); ?>>
												<?php esc_html_e('Sale Price', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?>
											</option>
											<option value="rtw_regular_price" <?php selected(isset($rtwwdpdl_gnrl_set['rtw_dscnt_on']) ? $rtwwdpdl_gnrl_set['rtw_dscnt_on'] : '', 'rtw_regular_price'); ?>>
								...
								<tr>
									...
									<td>
										<select name="rtw_auto_add_bogo">
											<option value="rtw_yes" <?php selected(isset($rtwwdpdl_gnrl_set['rtw_auto_add_bogo']) ? $rtwwdpdl_gnrl_set['rtw_auto_add_bogo'] : '', 'rtw_yes'); ?>>
												<?php esc_html_e('Yes', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?>
											</option>
											<option value="rtw_no" <?php selected(isset($rtwwdpdl_gnrl_set['rtw_auto_add_bogo']) ? $rtwwdpdl_gnrl_set['rtw_auto_add_bogo'] : '', 'rtw_no'); ?>>
												<?php esc_html_e('No', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite'); ?>
											</option>
										</select>
										<div class="rtwwdpdl_description">
