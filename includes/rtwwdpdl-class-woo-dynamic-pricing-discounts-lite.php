...
class Rtwwdpdl_Woo_Dynamic_Pricing_Discounts_Lite
{
	...
	private function rtwwdpdl_define_admin_hooks()
	{
		...
		$this->rtwwdpdl_loader->rtwwdpdl_add_filter('plugin_row_meta', $rtwwdpdl_plugin_admin, 'rtwwdpdl_plugin_row_meta_action_links', 20, 3);
	...
	private function rtwwdpdl_define_public_hooks()
	{
		...
		//====================================== update 1.6.2 ======================================//		
		// $this->rtwwdpdl_loader->rtwwdpdl_add_action('woocommerce_review_order_before_order_total', $rtwwdpdl_plugin_public, 'rtwwdpdl_review_order_before_order_total', 98);
		$this->rtwwdpdl_loader->rtwwdpdl_add_action('woocommerce_gateway_title', $rtwwdpdl_plugin_public, 'rtwwdpdl_woocommerce_gateway_title_change', 98, 2);
		$this->rtwwdpdl_loader->rtwwdpdl_add_action('woocommerce_checkout_order_processed', $rtwwdpdl_plugin_public, 'rtwwdpdl_woocommerce_checkout_order_processed', 10);
		$this->rtwwdpdl_loader->rtwwdpdl_add_action('woocommerce_blocks_checkout_order_processed', $rtwwdpdl_plugin_public, 'rtwwdpdl_woocommerce_checkout_order_processed', 10);
		$this->rtwwdpdl_loader->rtwwdpdl_add_action('wp_ajax_recalculate_cart_totals', $rtwwdpdl_plugin_public, 'rtwwdpdl_recalculate_cart_totals_callback', 10);
		$this->rtwwdpdl_loader->rtwwdpdl_add_action('wp_ajax_nopriv_recalculate_cart_totals', $rtwwdpdl_plugin_public, 'rtwwdpdl_recalculate_cart_totals_callback', 10);
		//====================================== update 1.6.2 ======================================//
